    ...
    >
        ...
        >
            ...
            <a-menu-item
                key="sub_choose"
                @titleClick="titleClick"
                @click="menuClick('/sindex/schoose')"
            >
            ...
            <a-sub-menu key="sub_process" @titleClick="titleClick">
                ...
                <a-menu-item
                    key="sub_paperdemo"
                    @click="menuClick('/sindex/spaperdemo')"
                >
                    论文初稿
                </a-menu-item>
            </a-sub-menu>
            ...
            <a-menu-item
                key="sub_library"
                @titleClick="titleClick"
                @click="menuClick('/sindex/slibrary')"
            >
                <a-icon type="home" />历史文库
            </a-menu-item>
            <a-menu-item
                key="sub_download"
                @titleClick="titleClick"
                @click="menuClick('/sindex/sdownload')"
            >
                <a-icon type="home" />资料文件下载
            </a-menu-item>
        </a-menu>
    </a-layout-sider>
</template>
