<template>
    <a-layout>
        <a-layout-header style="padding: 0 80px"><h2 style="color: white">毕业论文(设计)管理系统</h2></a-layout-header>
        <a-layout-content style="padding: 0 80px">
            <div :style="{padding: '32px 0px', minHeight: '280px' }">
                <div class="login-div" v-bind:style="{backgroundImage:'url('+bg+')'}">
                    <a-form
                        class="login-form"
                ...
                <div style="margin-top:32px">
                    <a-row type="flex">
                        <a-col :flex="3" :style="{marginRight:'32px',borderRadius:'5px'}">
                            <a-list bordered :data-source="informData" class="a-list">
                        ...
                        <a-col :flex="2" :style="{borderRadius:'5px'}"><!--横向比例布局-->
        ...
        <a-layout-footer :style="{ textAlign: 'center' }">
            <p>由 <a href="https://github.com/Alone-93" title="CX" target="_blank">CX</a>提供技术支持</p>
